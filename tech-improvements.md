...
- **2026-W32 — done:** The stale repository-overview finding filed as PRO-92 is resolved on main at `README.md:5-6`, `README.md:23`; the overview now describes the live wall tablet, Pi-hosted Home Assistant, and Google-backed data paths.
