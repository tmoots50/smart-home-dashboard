...
import { queueTrack } from '../../_lib/spotify-api.js';
...
export async function onRequest({ request, env }) {
  ...
  if (!String(body.uri || '').startsWith('spotify:track:')) return json({ error: 'track uri required' }, { status: 400 }, cors);
  try { return json(await queueTrack(env, body.uri, body.deviceId), {}, cors); }
