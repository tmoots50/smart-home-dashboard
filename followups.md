...
- **Activate the `tablet` QA profile** *(promoted from medium 2026-07-10 — the last big blind spot behind the density regression; hands-on, ~10 min at the wall)*. Runbook:
